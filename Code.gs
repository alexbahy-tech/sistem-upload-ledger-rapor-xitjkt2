 ...
 */
const CONFIG = {
  SHEET_ID: "1ZrsGzv1Qiya8FB_Yrz7yMjlSeASrq28x5nTptOmOo7Y", // ID Spreadsheet Database
  SHEET_NAME: "Sheet1",                                     // Nama Sheet
  PARENT_FOLDER_ID: "1hoLSy0ATQ4hwRSowVy4CHlxpiGY3VLpx",    // ID Folder Induk Siswa
  LEDGER_FOLDER_ID: "1o9LqVXysCzFEnXWxdVFdYOgzBwOQ46Vi"     // ID Folder Ledger
};
